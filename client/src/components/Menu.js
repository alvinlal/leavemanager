...
const Menu = ({ menuVisible, toggleMenu }) => {
      ...
      return (
        <>
          <div
            ...
            className='flex h-[70px] w-full cursor-pointer items-center px-6 py-3 text-white hover:bg-[#6C6E94]'
          >
          ...
          <div
            onClick={() => showComponent('/teachers')}
            className='flex h-[70px] w-full cursor-pointer items-center px-6 py-3 text-white hover:bg-[#6C6E94]'
          >
            <div className='flex h-[46px] w-[42px] items-center justify-center rounded-[5px] bg-[#3E4173]'>
          ...
          <div onClick={signOut} className='mt-14 flex h-[70px] w-full cursor-pointer items-center px-6 py-3 text-white hover:bg-[#6C6E94]'>
            <div className='flex h-[46px] w-[42px] items-center justify-center rounded-[5px] bg-[#3E4173]'>
  ...
  return (
    <div className={`${!menuVisible && 'hidden'} fixed left-0 top-0 z-10 h-[100vh] w-2/4 bg-primary md:block  md:w-[270px]`}>
      ...
      <div
        ...
        className='ml-auto mt-4 mr-7 flex h-9 w-9 items-center justify-center rounded-[5px] bg-[#3E4173] hover:cursor-pointer md:hidden'
      >
