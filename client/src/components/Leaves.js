  ...
  return (
    <div className='flex flex-col justify-center p-5 md:py-6 md:px-9'>
      ...
      <div className='flex items-center'>
        <h1 className='text-2xl font-bold text-primary md:text-4xl'>Leaves</h1>
      ...
      <div className='mt-8 mb-28 table w-full border-2 border-secondary md:mb-5 md:rounded-tr-xl md:border-t-0 md:border-l-0'>
        <div className='hidden h-24 w-full md:table-row'>
          ...
          <div className='table-cell border-l-2 border-t-2 border-secondary p-3 text-center align-middle text-xl font-bold text-primary '>Category</div>
          <div className='table-cell border-l-2 border-t-2 border-secondary p-3 text-center align-middle text-xl font-bold text-primary '>Apply Date</div>
          <div className='table-cell border-l-2 border-t-2 border-secondary p-3 text-center align-middle text-xl font-bold text-primary '>Start Date</div>
          <div className='table-cell border-l-2 border-t-2 border-secondary p-3 text-center align-middle text-xl font-bold text-primary '>End Date</div>
          <div className='table-cell border-l-2 border-t-2 border-secondary p-3 text-center align-middle text-xl font-bold text-primary '>Reason</div>
          <div className='table-cell border-l-2 border-t-2 border-secondary p-3 text-center align-middle text-xl font-bold text-primary '> Approval Status</div>
