...
const DepartmentModal = ({ handleClose, departments, setDepartments, isEditing, defaultValues }) => {
  const {
    register,
    handleSubmit,
    ...
    <div className='fixed left-0 right-0 bottom-0 z-40 flex h-screen w-screen items-center justify-center bg-black/25' onClick={handleClose}>
      ...
      >
        ...
        <div className='relative h-20 w-auto'>
          ...
          />
          <span className='pointer-events-none absolute  -top-[10px] left-4 bg-white p-1 text-xs text-[#909090]'>Name</span>
