...
const TeacherModal = ({ handleClose, teachers, setTeachers, isEditing, defaultValues }) => {
  ...
  const onSubmit = (teacherDetails) => {
    const { username, dept_id, teacher_firstname, teacher_lastname, teacher_designation } = teacherDetails;
    isEditing
      ? updateTeacher({ teacher_firstname, teacher_lastname, teacher_designation, dept_id, teacher_id: defaultValues.teacher_id })
      : addTeacher({ username, dept_id, teacher_firstname, teacher_lastname, teacher_designation });
  };
